  ...
  return (
    <div className="mx-auto max-w-screen-md px-4 py-16">
      <article className="prose prose-sm w-full max-w-none dark:prose-invert">
        ...
        <p>
          Welcome to Motion. This Privacy Policy explains how we collect, use, and protect your
          information when you use our wallet application and related services.
        </p>
        <p>
          By accessing or using Motion, you agree to the practices described in this Privacy Policy.
        ...
        <p>
          At Motion, your privacy and security are our top priorities. We do not collect or store:
        </p>
        <ul>
        ...
        <ul>
          <li>Improve the performance, functionality, and user experience of Motion.</li>
        ...
        <ul>
          ...
          <li>
            Motion does not store or have access to your keys or wallet contents, so we cannot
            recover lost data.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Email:</strong> support@motion.zip
          </li>
        </ul>
      </article>
    </div>
