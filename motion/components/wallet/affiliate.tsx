              ...
              <div className="flex min-w-0 max-w-fit items-center justify-between space-x-2 rounded-sm bg-secondary px-2 py-1.5">
                <div className="flex items-center space-x-2">
                  ...
                  <p className="min-w-0 truncate font-mono text-[11px] tracking-tight">
                    go.motion.zip/{data?.referralKey}
                  </p>
                </div>
                {data?.referralKey && (
                  <CopyButton text={`https://go.motion.zip/${data.referralKey}`} />
                )}
              </div>
            )}
          </div>
    ...
    <>
      <div className="space-y-2">
        ...
        <div className="space-y-1">
          ...
          <p className="ml-1 line-clamp-1 text-xs text-muted-foreground">From go.motion.zip</p>
        </div>
      </div>
      <AffiliateDialog
        isOpen={isOpen}
