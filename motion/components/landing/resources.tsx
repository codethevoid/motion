      ...
      <div className="mx-auto max-w-screen-lg space-y-8">
        <div className="space-y-2">
          ...
          <p className="mx-auto max-w-lg text-center text-sm text-muted-foreground max-sm:max-w-xs max-sm:text-[13px]">
            Explore our resources and learn more about Motion and how to use it.
          </p>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 max-md:grid-cols-1">
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="flex gap-3 max-md:flex-col">
                <Button className="w-full justify-between" asChild>
                  <NextLink href="https://x.com/motiondotzip" target="_blank">
                    <>
          ...
          <MagicCard className="p-6" gradientSize={160}>
            <div className="space-y-4">
              ...
              <div className="flex gap-3 max-md:flex-col">
                <Button className="w-full justify-between" asChild>
                  <NextLink href="https://docs.motion.zip" target="_blank">
                    <>
          ...
          <MagicCard className="p-6" gradientSize={160}>
            <div className="space-y-4">
              ...
              <div className="flex gap-3 max-md:flex-col">
                <Button className="w-full justify-between" asChild>
                  <NextLink href="mailto:support@motion.zip">
                    <>
