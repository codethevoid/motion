...
const resources = [
  ...
  { name: "Support", route: "mailto:support@motion.zip" },
  { name: "Docs", route: "https://docs.motion.zip" },
];
          ...
          <div className="col-span-2 space-y-5 max-sm:col-span-1">
            ...
            <div className="w-fit max-sm:mx-auto">
              <Button size="icon" className="size-8" variant="secondary" asChild name="x-link">
                <a href="https://x.com/motiondotzip" target="_blank">
                  <svg
            ...
            <div className="flex flex-col space-y-1.5">
              {resources.map((resource) => (
                <Link
                  ...
                  key={resource.name}
                  className="w-fit text-[13px] text-muted-foreground hover:text-foreground max-sm:mx-auto max-sm:text-center"
                  target={resource.route.includes("https") ? "_blank" : undefined}
                >
                  {resource.name}
                </Link>
              ))}
...
//           <a
//             href="mailto:support@motion.zip"
//             target="_blank"
...
//             </NextLink>
//           </div>
//           <p className="text-xs text-muted-foreground">&copy; {new Date().getFullYear()} Motion</p>
//         </div>
//       </div>
//     </div>
//   );
