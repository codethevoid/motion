    ...
    <div className="grid min-h-screen w-full place-items-center px-4 py-12">
      <div>
          ...
          >
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-[13px] text-muted-foreground">
                  Your password will be used to access your wallet on this device. We can not
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-[13px] text-muted-foreground">
                  {method === "mnemonic"
                    ? "Please enter your mnemonic phrase to import your wallet. Sepearate each word with a space."
        ...
        <p className="mx-auto mt-4 max-w-xs text-center text-xs text-muted-foreground">
          By importing your wallet, you agree to the{" "}
          <a
            href={`${protocol}${rootDomain}/legal/terms`}
            target="_blank"
          ...
          and{" "}
          <a
            href={`${protocol}${rootDomain}/legal/privacy`}
            target="_blank"
            className="text-foreground underline"
          >
            Privacy Policy
